...
RUST_LOG="$PRE_LAUNCH_LOG" target/release/pre_launch --config=src/bin/node_settings_local_raft_3.toml --type=mempool --index=2 > pre_launch_mempool_2.log 2>&1 &
c2=$!
RUST_LOG="$PRE_LAUNCH_LOG" target/release/pre_launch --config=src/bin/node_settings_local_raft_3.toml --type=mempool --index=1 > pre_launch_mempool_1.log 2>&1 &
c1=$!
RUST_LOG="$PRE_LAUNCH_LOG" target/release/pre_launch --config=src/bin/node_settings_local_raft_3.toml --type=mempool > pre_launch_mempool_0.log 2>&1 &
c0=$!
